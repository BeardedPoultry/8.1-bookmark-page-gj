...
this["JST"]["bookmark-item"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<p>"
    ...
    + "</p>\n<button class=\"bookmark-edit-button\">edit</button>\n\n<form class=\"bookmark-edit-form\">\n  <input class=\"bookmark-title\" type=\"text\" value=\""
    + alias3(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"title","hash":{},"data":data}) : helper)))
    + "\">\n  <input class=\"bookmark-url\" type=\"text\" value=\""
    + alias3(((helper = (helper = helpers.url || (depth0 != null ? depth0.url : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"url","hash":{},"data":data}) : helper)))
    + "\">\n  <input type=\"reset\" value=\"cancel\">\n  <input type=\"submit\" value=\"save\">\n</form>";
},"useData":true});
this["JST"]["bookmark"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "";
},"useData":true});